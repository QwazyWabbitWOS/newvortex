...
//	int			talentLevel;
    ...
    switch(selection)
	{
		...
		case 17:	//tballs
			...
			break;
//		case 18:	//respawns
//			qty		= ARMORY_QTY_RESPAWNS - ent->myskills.respawns;
//			//Base respawn price on how many the player needs.
//			price	= (int)((((float)qty) / 1000.0) * ((float)ARMORY_PRICE_RESPAWNS));
//			break;
		case 18:	//power cubes
			qty		= (MAX_POWERCUBES(ent) + 200) - ent->client->pers.inventory[ITEM_INDEX(Fdi_POWERCUBE)];
		...
		case 22:	//grav boots
			...
			slot	= V_FindFreeItemSlot(ent);
			break;
		case 23:	//fire resistant clothing
...
//	Talent: Bartering
//  decino: added back on NVRX 1.0
//	talentLevel = getTalentLevel(ent, TALENT_BARTERING);
	if(ent->myskills.talents.BarteringLevel > 0)		
	price *= 0.7 - 0.1 * ent->myskills.talents.BarteringLevel;
...
//				if (qty < 1)
//				{
//					gi.cprintf(ent, PRINT_HIGH, "You don't need respawns.\n");
//					return;
//				}
//				ent->myskills.respawns += qty;
//				gi.cprintf(ent, PRINT_HIGH, "You bought %d respawns.\n", qty);
//			}
//			break;
		case 18:	//Power Cubes
			{
		...
		case 20:	//Health Potions
		case 21:	//Antidote Potions (Holy Water)
		case 22:	//Anti-Grav boots
		case 23:	//Fire resist clothing
		case 24:	//Auto-tball
			{
				if (slot == NULL)
				{
                ...
                switch(selection)
				{
				case 20:	gi.cprintf(ent, PRINT_HIGH, "You bought %d health potions.\n", qty);		break;
				case 21:	gi.cprintf(ent, PRINT_HIGH, "You bought %d vials of holy water.\n", qty);	break;
				case 22:	gi.cprintf(ent, PRINT_HIGH, "You bought a pair of anti-gravity boots.\n");	break;
				case 23:	gi.cprintf(ent, PRINT_HIGH, "You bought some fire resistant clothing.\n");	break;
				case 24:	gi.cprintf(ent, PRINT_HIGH, "You bought an Auto-Tball.\n");	break;
				}
			}
			break;
		case 28:	//Reset char data
