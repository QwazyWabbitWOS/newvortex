		...
		for (j = 0; j < MAX_WEAPONMODS; ++j)
		{
			...
			if(ent->myskills.weapons[i].mods[j].soft_max == 0 || ent->myskills.weapons[i].mods[j].hard_max == 0)
			{
				...
				if (ent->myskills.class_num != CLASS_WEAPONMASTER || !GiveWeaponMasterUpgrade(ent, i, j))
				{
					...
					{
						ent->myskills.weapons[WEAPON_SWORD].mods[0].soft_max = 20;
						ent->myskills.weapons[WEAPON_SWORD].mods[0].hard_max = 40;

						ent->myskills.weapons[WEAPON_SWORD].mods[1].soft_max = 20;
						ent->myskills.weapons[WEAPON_SWORD].mods[1].hard_max = 40;

						ent->myskills.weapons[WEAPON_SWORD].mods[2].soft_max = 10;
						ent->myskills.weapons[WEAPON_SWORD].mods[2].hard_max = 20;

						ent->myskills.weapons[WEAPON_SWORD].mods[3].soft_max = 20;
						ent->myskills.weapons[WEAPON_SWORD].mods[3].hard_max = 40;

						ent->myskills.weapons[WEAPON_SWORD].mods[4].soft_max = 1;
						ent->myskills.weapons[WEAPON_SWORD].mods[4].hard_max = 1;
					}
				}
			}
		}
