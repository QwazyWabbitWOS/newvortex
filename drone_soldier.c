...
void soldier_fireblaster (edict_t *self)
{
	...
	MonsterAim(self, 0.9, speed, false, MZ2_SOLDIER_BLASTER_8, forward, start);
...
void soldier_firerocket (edict_t *self)
{
	...
	MonsterAim(self, 0.9, speed, true, MZ2_SOLDIER_BLASTER_8, forward, start);
...
void soldier_fireshotgun (edict_t *self)
{
	...
	MonsterAim(self, 0.9, 0, false, MZ2_SOLDIER_SHOTGUN_8, forward, start);
