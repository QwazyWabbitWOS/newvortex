...
#define TALENT_BASIC_HA				14//decino: general talent now
//Poltergeist
#define TALENT_MORE_AMMO			20
#define TALENT_SUPERIORITY			21//decino: general talent now
